...
public class MeetingProductAppController {
    ...
    public Page<MeetingProductVO> pageProduct(@RequestBody ProductListQuery query) {
        MeetingValidate.checkPageProduct(query);
    ...
    @PostMapping("/getByteByDate")
    public TimeResourceVO getByteByDate(@RequestBody TimeResourceQuery query) {
        TimeResourceValidate.checkTimeResourceQuery(query);
        return meetingService.getTimeResource(query);
    }
    ...
    @PostMapping("/book")
    public String book(@RequestBody MeetingBookQuery query) {
        MeetingValidate.checkBookQuery(query);
        return productService.createBookOrder(query);
    }
}
