...
public class OfficeBookServiceImpl extends BookServiceImpl implements OfficeBookService {
    ...
    public void book(OfficeBookVO officeBookVO) {
        String[] params = {"applyTime","name","phone"};
     ...
     */
    @Override
    public Page listByPageAndOfficeId(Page page) {
        ...
        List<Book> bookRecords = page.getRecords();
        //初始化records
        List<OfficeBookVO> records = CollectionUtil.createArrayList();
