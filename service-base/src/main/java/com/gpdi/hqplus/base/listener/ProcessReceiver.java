 ...
 * @author: zake
 * @Description:
 * @Date: Created in 14:48 2019-07-16
 **/
@Component
public class ProcessReceiver implements ChannelAwareMessageListener {
    ...
    public void onMessage(Message message, Channel channel) throws Exception {
        try {
            ...
            channel.basicPublish(RabbitDelayQueue.PER_QUEUE_TTL_EXCHANGE_NAME, RabbitDelayQueue.DELAY_QUEUE_PER_QUEUE_TTL_NAME, null,
